// https://observablehq.com/@tatitozzi/hierarchical-bar-chart@333
...
FileAttachment("/DOC_Analysis/files/json/grafico05.json").json()
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["dados.json", {url: "./dados.json", mimeType: "application/json", toString}]
  ]);
